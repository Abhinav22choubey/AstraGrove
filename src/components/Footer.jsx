        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-auto flex justify-center lg:justify-start">
            <div className="flex items-center gap-3">
              ...
              <div className="w-[65px] h-[65px] bg-white/10 rounded overflow-hidden flex-shrink-0 flex items-center justify-center">
                <span className="text-[10px] text-center leading-tight opacity-70">Asper<br/>School</span>
              </div>
              <h1 
          ...
          <div className="w-full lg:w-auto flex flex-col items-center lg:items-start gap-6 font-['Kanit'] mt-4 lg:mt-0">
            ...
            <div className="flex flex-row items-center gap-[18px]">
              {/* YouTube Icon */}
              <a href="#" className="w-[50px] h-[50px] bg-white/10 rounded flex items-center justify-center hover:bg-white/20 transition-all">
